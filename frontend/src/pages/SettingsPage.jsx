    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-2xl space-y-4 sm:space-y-6">
      ...
      <FormSection title="Profile Information" icon={User} delay={0.1}>
        <form onSubmit={profileForm.handleSubmit(handleProfileSave)} className="space-y-4">
          ...
          <div>
            <label className="label-text block mb-2">Mobile Number <span className="text-white/20">(for OTP login)</span></label>
            <div className="flex gap-2">
              <div className="flex items-center px-3 rounded-lg border border-white/10 bg-white/4 text-white/40 text-sm font-mono flex-shrink-0">
                🇮🇳 +91
              </div>
              <input type="tel" inputMode="numeric" maxLength={10} className="input-field flex-1"
                placeholder="10-digit mobile number"
                {...profileForm.register('phone')} />
            </div>
            <p className="text-xs text-white/25 mt-1.5">
              Add your number to enable Mobile OTP login.
            </p>
          </div>
