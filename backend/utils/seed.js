...
const ADMIN_EMAIL    = process.env.SEED_EMAIL    || 'admin@yourdomain.com';
const ADMIN_PASSWORD = process.env.SEED_PASSWORD || 'ChangeMe@123';
const ADMIN_NAME     = process.env.SEED_NAME     || 'Admin';
const ADMIN_PHONE    = process.env.SEED_PHONE    || ''; // 10-digit mobile, for OTP login
